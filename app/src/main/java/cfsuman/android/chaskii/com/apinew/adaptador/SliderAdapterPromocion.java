...
public class SliderAdapterPromocion extends PagerAdapter {
    ...
    public SliderAdapterPromocion(Context context,ArrayList<MoPromocion> listaPromocion)
    {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        Picasso.get()
                .load(Uri.parse("http://subdominio.maprocorp.com/images/promocion/"+listapromocion.get(position).getImagen()))
        ...
        sliderImagen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                varGlobal.setPromocionId(listapromocion.get(position).getId());
