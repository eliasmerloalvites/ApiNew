...
public class SliderAdapterCategoria extends PagerAdapter {
    ...
    public SliderAdapterCategoria(Context context, ArrayList<MoCAdicionales> listaadicionales)
    {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        View view = layoutInflater.inflate(R.layout.slider_layoutpromociones,container,false);
        final int radius = 0;
        final int margin = 0;
        ...
        Picasso.get()
                .load(Uri.parse("http://subdominio.maprocorp.com/images/servicio/"+listaadicionales.get(position).getImagen()))
        ...
        sliderImagen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                varGlobal.setPromocionId(listaadicionales.get(position).getId());
